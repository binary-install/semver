...
func TestResolver_MaxSatisfying(t *testing.T) {
	tests := []struct {
		...
		{
			name: "exact version from releases",
			releases: []github.Release{
				{Tag: "v1.20.0", Draft: false},
				{Tag: "v1.21.0", Draft: false},
				{Tag: "v1.22.0", Draft: false},
			},
			constraint: "1.21.0",
			want:       "v1.21.0",
			wantErr:    false,
		...
		{
			name: "range constraint from releases",
			releases: []github.Release{
				{Tag: "v1.20.0", Draft: false},
				{Tag: "v1.21.0", Draft: false},
				{Tag: "v1.21.5", Draft: false},
				{Tag: "v1.22.0", Draft: false},
			},
		...
		{
			name: "tilde range from releases",
			releases: []github.Release{
				{Tag: "v1.21.0", Draft: false},
				{Tag: "v1.21.5", Draft: false},
				{Tag: "v1.22.0", Draft: false},
		...
		{
			name: "caret range from releases",
			releases: []github.Release{
				{Tag: "v1.21.0", Draft: false},
				{Tag: "v1.21.5", Draft: false},
		...
		{
			name: "releases only by default",
			tags: []string{"v1.0.0", "v1.1.0", "v1.2.0"},
			releases: []github.Release{
				{Tag: "v1.0.0", Draft: false},
			},
			constraint: "^1.0.0",
			want:       "v1.0.0", // Only release version
			wantErr:    false,
		},
		{
			name: "include tags when enabled",
			tags: []string{"v1.0.0", "v1.1.0", "v1.2.0"},
			releases: []github.Release{
				{Tag: "v1.0.0", Draft: false},
			},
			constraint: "^1.0.0",
			options:    resolver.Options{IncludeTags: true},
			want:       "v1.2.0", // Highest version from tags
			wantErr:    false,
		},
	}
